...
import turtle
import math
wdth = 800; hgth = 800; bgstring = "#ffffcc"
red = "#770000"; green = "#007700"; blue = "#000077"
...
def plotCircles(t):
	#list  named d and c
	d =  [11.75, 11.5, 31, 26.25, 35, 34, 12.8, 1.8, 19.8, 8.7] 
	c =  [3.5, 3.5, 10, 8.5, 111, 108, 37,  4.7, 57.1, 26.1] 
	...
	t.dot(3, green)
	t.goto(dsorted[6],csorted[6])
	t.dot(3, blue)
	t.goto(dsorted[7],csorted[7])
	t.dot(3, blue)
	t.goto(dsorted[8],csorted[8])
	t.dot(3, blue)
	t.goto(dsorted[9],csorted[9])
	t.dot(3, blue)
